 ...
 * app_settings table) — "anthropic", "gemini", or "groq" — with the
 * AI_PROVIDER env var as a hard local override for testing. Every caller in
 * this file (and every API route) goes through this one function, so the
